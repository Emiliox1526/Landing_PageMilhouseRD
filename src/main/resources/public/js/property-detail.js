...
(function () {
    ...
    function renderProperty(p){
        ...
        const isApt = isApartmentType(propType);
  ...
  <!-- Stats: solo se muestran si NO es apartamento/penthouse -->
  ${!isApt ? `
    ...
    <p class="mb-0">${p.descriptionParagraph.replace(/\n/g, '<br>')}</p>
      ...
      <div class="card section-card calc-card mb-5">
        <div class="card-header">
          <h2 class="h5 m-0">Calcula tu cuota mensual</h2>
        </div>
        ...
        <div class="card-body">
          <div id="loanCalc" class="calculator">
            ...
            <aside class="result-hero">
              <div class="result-title">Cuota estimada aproximada</div>
